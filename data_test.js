...
async function main() {
  //  for await (const sector of sectors) { //for inserting all the sectors to DB
  //   if(sector.parentSectorValue) {
  //       const parent = await client.sector.findUnique({
  //         where: {
  //           value: sector.parentSectorValue
  //         }
  //       });
  
  //       console.log({ parent })
  //       parent && await client.sector.create({
  //         data: {
  //           parentId: parent.id,
  //           name: sector.name,
  //           value: sector.value,
  //           hasNext: sector.hasNext
  //         }
  //       }).catch((err) => {
  //         console.log({err, sector})
  //       })
  ...
  //  }
      ...
      const get = await client.sector.findMany(
        {
          where: {
            parentId: null
          },
